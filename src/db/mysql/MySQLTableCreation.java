...
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			// machine table
			sql = "CREATE TABLE machines (" + "machine_id VARCHAR(255) NOT NULL," + "availability BOOLEAN DEFAULT true,"
					+ "user_id VARCHAR(255)," + "start_time TIMESTAMP NULL DEFAULT NULL,"
					+ "end_time TIMESTAMP NULL DEFAULT NULL," + "PRIMARY KEY (machine_id)" +
					// ")";
